		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "KaraFi",
									"targetURL": "#comkarafikarafisapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkarafikarafisapui5-display": {
								"semanticObject": "comkarafikarafisapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.karafi.karafisapui5",
									"url": sap.ui.require.toUrl("com/karafi/karafisapui5")
								}
							}
						}
					}
